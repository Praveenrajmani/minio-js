    ...
    step(`listObjects(bucketName, prefix, recursive)_bucketName:${bucketName}, recursive:false_`, done => {
      client.listObjects(bucketName, listObjectPrefix, false)
        ...
        .on('end', () => {
            ...
            try {
                var removeStream = client.removeObjects(bucketName, '');
    ...
    step(`listObjects(bucketName, prefix, recursive)_bucketName:${bucketName}, recursive:false_`, done => {
        ...
        client.listObjects(bucketName, listObjectPrefix, false)
            ...
            .on('end', () => {
                close(channel);
                try {
                    var removeStream = client.removeObjects(bucketName, channel);

                    removeStream.on('data', function(obj) {
                        done()
                    })
